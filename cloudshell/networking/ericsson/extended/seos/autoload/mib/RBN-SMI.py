...
# ASN.1 source file://C:\MIBS\text_mibs\RBN-SMI.my
...
rbnSMI = ModuleIdentity((1, 3, 6, 1, 4, 1, 2352)).setRevisions(
    ("2011-01-19 18:00", "2002-06-06 00:00", "2001-06-27 00:00", "1998-04-18 23:00",))
...
mibBuilder.exportSymbols("RBN-SMI", rbnMgmt=rbnMgmt, PYSNMP_MODULE_ID=rbnSMI, rbnSMI=rbnSMI,
                         rbnCapabilities=rbnCapabilities, rbnInternal=rbnInternal, rbnEntities=rbnEntities,
                         rbnProducts=rbnProducts, rbnExperiment=rbnExperiment, rbnModules=rbnModules)
